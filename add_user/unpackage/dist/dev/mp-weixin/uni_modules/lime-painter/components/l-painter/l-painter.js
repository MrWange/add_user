...
const _sfc_main = {
  ...
  created() {
    this.show = true;
    this.use2dCanvas = this.type === "2d" && uni_modules_limePainter_components_lPainter_utils.canIUseCanvas2d();
    this.isPC = uni_modules_limePainter_components_lPainter_utils.isPC;
  },
  async mounted() {
  ...
  methods: {
    ...
    async render(args = {}) {
      ...
      this.painter = null;
      if (!this.painter) {
        const { width: width2 } = args.css || args;
        args.css || args;
        ...
        this.painter = new uni_modules_limePainter_components_lPainter_painter.Mt(param);
      }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: $options.canvasId,
    f: common_vendor.s($options.size),
    g: $options.canvasId,
    h: $options.boardWidth * $options.dpr,
    i: $options.boardHeight * $options.dpr
  }, {
    j: common_vendor.s($options.styles)
  }) : {});
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/29337/Desktop/add_user/add_user/uni_modules/lime-painter/components/l-painter/l-painter.vue"]]);
